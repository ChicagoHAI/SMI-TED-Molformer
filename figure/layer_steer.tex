...
\caption{Intervention success rate per steer layer on eight per-atom QM9 properties. On the contextual properties, \smi's success rises rapidly and saturates at $1.0$ by mid-layers, while \molm's climbs gradually and only reaches $1.0$ near the top of the encoder, indicating different depths of usage.}
